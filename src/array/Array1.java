...
public class Array1 {
	...
	public static void main(String[] args) {
		...
		* 	학생을 몇 명 더 추가하는 것은 개발자가 코딩으로 해결할 수 있겠지만, 학생을 수백 명 이상 추가해야 한다면 코드가 상당이 많이 늘어날 것이다.
		* 	결국 학생 수가 증가함에 따라 코딩 양이 비례해서 증가하는 문제가 발생한다.
		* - 변수를 선언하는 부분을 보면 학생 수가 증가함에 따라 int형 변수를 계속해서 추가해야 한다.
		* 	학생 수가 5명이면 int형 변수를 5개 선언해야 하고, 학생 수가 100명이라면 int형 변수를 100개 선언해야 한다.
